            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse {{ request()->is('proyectos') || request()->is('recientes/*') ? 'show' : '' }}" id="sidebar-special" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#recent-projects" role="button" aria-expanded="false" aria-controls="recent-projects">
                            ...
                            <ul class="sub-nav collapse" id="recent-projects">
                                <li class="nav-item" id="loadingRecientesLi">
                                    <span id="loadingRecientes" class="nav-link text-muted">Cargando...</span>
                                </li>
                                <li class="nav-item d-none" id="noRecientesLi">
                                    <span id="noRecientes" class="nav-link text-muted">Sin proyectos recientes</span>
                                </li>
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Panel Admin</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
