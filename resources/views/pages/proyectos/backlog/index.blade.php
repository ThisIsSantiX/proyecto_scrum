                ...
                <div class="card shadow-sm border">
                    <div class="card-body py-2 pb-0">
                        ...
                        <ul class="nav flex-row mt-2">
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:void(0)" data-target="vista-pendiente">Trabajo
                                    pendiente</a>
>>>>>>> Stashed changes
                            </li>
                            <li class="nav-item">
...
>>>>>>> Stashed changes
            ...
            <div class="modal fade" id="modalHistoria" tabindex="-1" aria-labelledby="modalHistoriaLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form id="formHistoria">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="valor_historia" class="form-label">Valor de Historia</label>
                                            <input type="number" class="form-control" id="valor_historia"
                                                name="valor_historia" min="1" max="100" required>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="modalHistoriaEdit" tabindex="-1" aria-labelledby="modalHistoriaEditLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formHistoriaEdit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="edit_valor_historia" class="form-label">Valor de Historia</label>
                                        <input type="number" class="form-control" id="edit_valor_historia"
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" form="formHistoriaEdit" class="btn btn-primary"
                                id="btnActualizarHistoria">
                                <i class="bi bi-save me-2"></i> Guardar Cambios
                            </button>
                        </div>
                    </div>
            ...
            <!-- Modal para crear sprint -->
            <div class="modal fade" id="modalSprint" tabindex="-1" aria-labelledby="modalSprintLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formEditarSprint">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Nombre del Sprint</label>
                                    <input type="text" id="editarNombreSprint" name="nombre" class="form-control"
                                        required>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Fecha Fin</label>
                                            <input type="date" id="editarFechaFin" name="fecha_fin"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                </div>
...
>>>>>>> Stashed changes
                ...
                function cargarTablero(proyectoUID, sprintUID) {
                    ...
                    axios.get(`/proyectos/${proyectoUID}/sprints/${sprintUID}/board/view`, {
                        ...
                        .then(response => {
                            if (!response.data.success) {
                                notyf.error(response.data.message || "Error al cargar ítems del tablero");
                                return;
                            }
                            ...
                            .then(function(response) {
                                ...
                                `);
                                        ...
                                        items.forEach(function(item) {
                                            ...
                                            const prioridadClass = item.prioridad?.toLowerCase() === 'alta' ?
                                                'prioridad-alta' :
                                                item.prioridad?.toLowerCase() === 'media' ? 'prioridad-media' :
                                                'prioridad-baja';
                        ...
                        axios.get(`/reuniones`)
                            .then(function(response) {
                                if (response.data.success) {
                                    ...
                                    notyf.error(response.data.message || 'Error al cargar las reuniones');
                                }
                            })
                            .catch(function(error) {
            ...
            `;
                    ...
                    function cargarProyectos() {
                        ...
                        proyectos.forEach(proyecto => {
                            $('#id_proyectos').append(`<option value="${proyecto.id}">${proyecto.nombre}</option>`);
                        ...
                        axios.post(`/proyectos/backlog/${proyectoUID}/reuniones/store`, formData)
                            .then(function(response) {
                                ...
                                if (response.data.success) {
                                    ...
                                    notyf.error(response.data.message || 'Error al crear la reunión');
                                }
                            })
                            .catch(function(error) {
                    ...
                    function actualizarReunion() {
                        ...
                        axios.put(`/proyectos/backlog/${uid}/reuniones/update`, {
                            ...
                            .then(function(response) {
                                console.log('Respuesta actualización:', response.data); // Para debugging
                                ...
                                if (response.data.success) {
                                    ...
                                    notyf.error(response.data.message || 'Error al actualizar la reunión');
                                }
                            })
                            .catch(function(error) {
                    ...
                    function verReunion(uid) {
                        ...
                        // Campos de texto
                        $('#detail_observaciones').text(reunion.observaciones || 'No hay observaciones');
                        $('#detail_bloqueos').text(reunion.bloqueos_detectados || 'No se detectaron bloqueos');
                        $('#detail_acuerdos').text(reunion.acuerdos || 'No se registraron acuerdos');
